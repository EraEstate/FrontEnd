...
const stats = [
  { icon: Building2, label: '12.000+ Tin cho thue' },
  { icon: Users, label: '5.000+ Chu nha' },
  { icon: Smile, label: '98% Hai long' },
];
  ...
  return (
    <section className="bg-gradient-to-br from-white via-rose-50 to-red-100 pt-24 pb-12">
      <div className="mx-auto max-w-7xl px-4">
        <h1 className="text-3xl font-semibold text-gray-900 md:text-5xl">Cho thue & Tim nha cho thue</h1>
        <p className="mt-4 max-w-2xl text-base text-gray-700 md:text-lg">
          Tim can ho, phong tro, nha pho phu hop ngan sach va nhu cau trong vai phut.
        </p>
        ...
        <div className="mt-8 rounded-full border border-red-100 bg-white p-2 shadow-sm">
          <div className="flex flex-col gap-2 md:flex-row">
            <input
              ...
              placeholder="Nhap khu vuc can tim..."
            />
            <Link
