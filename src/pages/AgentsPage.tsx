...
const TopAgents: React.FC<TopAgentsProps> = ({ topAgentsList }) => (
  <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
    <h2 className="text-2xl font-semibold text-gray-900 mb-6">Môi Giới Hàng Đầu</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {topAgentsList.slice(0, 3).map((agent: Agent, index: number) => (
        <div key={agent.id} className="text-center">
          ...
          <h3 className="font-semibold text-gray-900 mb-1">{agent.fullName}</h3>
...
const AgentsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Top Agents */}
        {!loading && agents.length > 0 && <TopAgents topAgentsList={topAgentsList} />}
